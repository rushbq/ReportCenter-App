...
public class MockReportService : IReportService
{
    ...
    private static readonly Dictionary<string, List<Report>> _reports = new()
    {
        ...
        [
            ...
            new() { Name = "客戶帳款回收分析", Desc = "應收帳款回收天數與逾期比率", Cat = "客戶分析", Updated = "03/14", Fav = false },
            new() { Name = "產品退貨率統計", Desc = "各產品線退貨率與原因分析", Cat = "產品銷售", Updated = "03/13", Fav = false },
        ],
        ["finance"] =
        [
            ...
            new() { Name = "應付帳款帳齡表", Desc = "供應商應付帳款帳齡分佈", Cat = "帳齡分析", Updated = "03/17", Fav = false },
            new() { Name = "費用報銷統計", Desc = "各部門費用報銷金額與趨勢", Cat = "收支分析", Updated = "03/16", Fav = false },
        ],
        ["hr"] =
        [
            ...
            new() { Name = "離職率趨勢分析", Desc = "月度離職率與離職原因統計", Cat = "人力配置", Updated = "03/14", Fav = false },
            new() { Name = "招募進度追蹤", Desc = "各部門招募需求與面試進度", Cat = "招募進度", Updated = "03/13", Fav = true },
            new() { Name = "薪資結構分析", Desc = "各職等薪資分佈與市場比較", Cat = "薪資統計", Updated = "03/12", Fav = false },
        ],
        ["it"] =
        [
            ...
            new() { Name = "設備資產盤點", Desc = "IT 設備清冊與折舊狀態", Cat = "設備管理", Updated = "03/16", Fav = false },
            new() { Name = "網路流量監控", Desc = "內外部網路流量與異常偵測", Cat = "系統監控", Updated = "03/15", Fav = true },
        ],
    };
    ...
    [
        ...
        new() { Material = "鋁合金管 6061", Supplier = "建大鋁業", Qty = "1,800 KG", UnitPrice = "$165", Amount = "$297,000", Change = 3.2 },
        new() { Material = "工業用膠帶", Supplier = "三和黏著", Qty = "5,000 捲", UnitPrice = "$25", Amount = "$125,000", Change = -0.5 },
        new() { Material = "精密軸承 6205", Supplier = "東培工業", Qty = "3,200 PCS", UnitPrice = "$48", Amount = "$153,600", Change = -1.8 },
        new() { Material = "氟橡膠 O-ring", Supplier = "聯合橡膠", Qty = "15,000 PCS", UnitPrice = "$5.5", Amount = "$82,500", Change = 0.3 },
        new() { Material = "鍍鋅鋼板 SGCC", Supplier = "中鋼構造", Qty = "4,800 KG", UnitPrice = "$72", Amount = "$345,600", Change = -3.1 },
        new() { Material = "PP 射出料", Supplier = "台塑石化", Qty = "6,500 KG", UnitPrice = "$38", Amount = "$247,000", Change = 1.5 },
        new() { Material = "伺服馬達 750W", Supplier = "台達電子", Qty = "120 PCS", UnitPrice = "$4,800", Amount = "$576,000", Change = -0.6 },
        new() { Material = "不鏽鋼焊條 E308", Supplier = "大同特殊鋼", Qty = "2,000 KG", UnitPrice = "$95", Amount = "$190,000", Change = 2.1 },
        new() { Material = "液壓油 HM46", Supplier = "中油化學", Qty = "3,000 L", UnitPrice = "$52", Amount = "$156,000", Change = -1.2 },
        new() { Material = "碳纖維布 3K", Supplier = "台塑碳纖", Qty = "800 M²", UnitPrice = "$380", Amount = "$304,000", Change = 4.5 },
        new() { Material = "LED 驅動模組", Supplier = "億光電子", Qty = "2,500 PCS", UnitPrice = "$65", Amount = "$162,500", Change = -2.8 },
        new() { Material = "彈簧鋼線 SWC", Supplier = "嘉義銅業", Qty = "1,500 KG", UnitPrice = "$125", Amount = "$187,500", Change = 0.9 },
        new() { Material = "耐熱矽膠管", Supplier = "聯合橡膠", Qty = "4,000 M", UnitPrice = "$18", Amount = "$72,000", Change = -0.4 },
    ];
